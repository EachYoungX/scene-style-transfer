"""Create generated-result strips for U / U_budget / S_raw seed42 controls."""
...
def make_case(case_id: str, stem: str) -> Image.Image:
    ...
    budget = UBUDGET / case_id / "seed42"
    panels = [
        panel(base / "content.png", "content"),
        panel(base / "style.png", "reference"),
        panel(base / "U.png", "U"),
        panel(budget / "U_budget.png", "U_budget"),
        panel(base / "S_subject.png", "S_raw"),
    ]
    gutter = 8
    ...
    for item in panels:
        ...
        x += item.width + gutter
    path = OUTPUT / f"{stem}_seed42_u_budget_comparison.png"
...
def main() -> None:
    ...
    for item in strips:
        ...
        y += item.height + 12
    path = OUTPUT / "all_cases_seed42_u_budget_comparison.png"
    canvas.save(path)
    print(path)
